    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Coluna 1 - Sobre */}
          <div>
            <h3 className="text-lg font-semibold mb-4">Sobre o Condomínio Conexão</h3>
            <p className="text-gray-400">
              Conectando moradores, facilitando a comunicação e tornando a vida no condomínio mais prática e agradável.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/credits" className="text-gray-400 hover:text-white transition-colors">
                  Créditos
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>Email: contato@condominioconexao.com</li>
